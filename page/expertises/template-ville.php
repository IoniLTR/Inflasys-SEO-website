...
<?php
   ...
   $part2_blocks = [ 
   ["img"=>"uploads/default.png", "title"=>"Une qualité esthétique inégalée", "text"=>"Un site internet nouvellement créé bénéficie d'un design contemporain et intuitif, conçu sur mesure pour répondre à vos besoins et à l'image de votre marque. En utilisant des outils de création de pointe, tels que Webflow, votre site se démarquera par son esthétisme et son ergonomie."],
   ["img"=>"uploads/default.png", "title"=>"Un site 100% personnalisé", "text"=>"La création de votre site internet s'appuie sur des technologies de pointe, offrant une interface de gestion conviviale pour faciliter la mise à jour de votre contenu. Ces technologies intègrent également les meilleures pratiques SEO, garantissant une visibilité optimale sur les moteurs de recherche."],
   ["img"=>"uploads/default.png", "title"=>"Une interface intuitive", "text"=>"Un site internet flambant neuf, au design soigné et moderne, reflète le professionnalisme et le sérieux de votre entreprise. Il inspire confiance aux visiteurs et renforce l'image positive de votre marque"],
   ["img"=>"uploads/default.png", "title"=>"Aucun frais caché", "text"=>"Votre nouveau site internet devient un véritable atout marketing. Son design attrayant et sa navigation intuitive incitent les visiteurs à explorer votre offre et à passer à l'action, maximisant ainsi l'impact de vos campagnes marketing et améliorant votre taux de conversion."]
...
<?php
   ...
   $work_img_src = "uploads/default.png";
...
<?php
   ...
   $cat_reviews = [
       ["name" => "Jean Dupont", "job" => "Airbus", "text" => "Service impeccable.", "logo" => "uploads/Logo/clients/Chanel-logo.png"],
       ["name" => "Marie", "job" => "Vinci", "text" => "Très pro.", "logo" => "uploads/Logo/clients/Chanel-logo.png"],
       ["name" => "Pierre", "job" => "Thales", "text" => "Réactifs.", "logo" => "uploads/Logo/clients/Chanel-logo.png"],
       ["name" => "Sophie", "job" => "Renault", "text" => "Top.", "logo" => "uploads/Logo/clients/Chanel-logo.png"],
       ["name" => "Luc", "job" => "Dior", "text" => "Parfait.", "logo" => "uploads/Logo/clients/Chanel-logo.png"]
   ];
