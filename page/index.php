...
$hero_image_path = "uploads/default.png";
...
$reviews = [
    ...
    "logo" => $images_url . "uploads/Logo/clients/Chanel-logo.png"
    ],
    ["name" => "Marie Curie", "job" => "Chef de Projet - Vinci", "text" => "Le mur acoustique gonflable a permis de réduire les nuisances sonores de 20dB.", "logo" => $images_url . "uploads/Logo/clients/Chanel-logo.png"],
    ["name" => "Col. Moutarde", "job" => "Armée de Terre", "text" => "Le réalisme des leurres gonflables est impressionnant. Thermique et radar conformes.", "logo" => $images_url . "uploads/Logo/clients/Chanel-logo.png"],
    ["name" => "Sophie Martin", "job" => "Dir. Usine - Renault", "text" => "Maintenance facilitée grâce aux tentes de décontamination. Service client au top.", "logo" => $images_url . "uploads/Logo/clients/Chanel-logo.png"],
    ["name" => "Luc Besson", "job" => "Prod - EuropaCorp", "text" => "Structures gonflables sur mesure pour nos décors de cinéma. Rendu parfait.", "logo" => $images_url . "uploads/Logo/clients/Chanel-logo.png"],
    ["name" => "Paul Atréides", "job" => "Logistique - Arrakis", "text" => "Résistance aux vents de sable incroyable. Nos camps de base sont sécurisés.", "logo" => $images_url . "uploads/Logo/clients/Chanel-logo.png"],
    ["name" => "Sarah Connor", "job" => "Sécurité - Cyberdyne", "text" => "Les leurres ont parfaitement détourné l'attention. Mission accomplie.", "logo" => $images_url . "uploads/Logo/clients/Chanel-logo.png"],
    ["name" => "Tony Stark", "job" => "CEO - Stark Ind.", "text" => "Technologie gonflable impressionnante, déploiement en un temps record.", "logo" => $images_url . "uploads/Logo/clients/Chanel-logo.png"],
    ["name" => "Bruce Wayne", "job" => "PDG - Wayne Ent.", "text" => "Discrétion et efficacité pour nos abris temporaires. Je recommande.", "logo" => $images_url . "uploads/Logo/clients/Chanel-logo.png"],
    ["name" => "Ellen Ripley", "job" => "Officier - Nostromo", "text" => "Le sas de décontamination nous a sauvé la mise. Fiabilité absolue.", "logo" => $images_url . "uploads/Logo/clients/Chanel-logo.png"],
];
