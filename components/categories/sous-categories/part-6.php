...
<?php
   ...
   // IMAGE PATTERN
   $part8_pattern = $base_url . "uploads/Picto/pattern-1.webp"; 
   ...
   // BOUTON TOUT VOIR
   $part8_all_link  = $base_url . "nos-realisations";
   $part8_all_label = "Tout voir";

  require_once __DIR__ . '/../../components/categories/sous-categories/part-6.php';
?>
-------------------------------------------------------------- */
?>
  ...
  <div class="cat-realisations-content">
    <?php foreach ($part8_projects as $project): ?>
        <a class="cat-realisation-item" href="<?php echo $base_url?><?= htmlspecialchars($project['href'], ENT_QUOTES, 'UTF-8') ?>">
          <img src="<?php echo $images_url?><?= htmlspecialchars($project['img'], ENT_QUOTES, 'UTF-8') ?>" alt="<?= htmlspecialchars($project['title'], ENT_QUOTES, 'UTF-8') ?>">
